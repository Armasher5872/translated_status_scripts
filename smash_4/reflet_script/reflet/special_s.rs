...
unsafe extern "C" fn reflet_special_s_main_status(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    smash::app::FighterSpecializer_Reflet::change_hud_kind(app_fighter, *FIGHTER_REFLET_MAGIC_KIND_GIGA_FIRE);
    if !CancelModule::is_enable_cancel(fighter.module_accessor) {
        ...
        if WorkModule::is_flag(fighter.module_accessor, *FIGHTER_REFLET_STATUS_SPECIAL_S_FLAG_SHOOT_OK) {
            ...
            if current_point <= 0.0 {
                smash::app::FighterSpecializer_Reflet::set_flag_to_table(fighter_module_accessor, *FIGHTER_REFLET_MAGIC_KIND_GIGA_FIRE, true, *FIGHTER_REFLET_INSTANCE_WORK_ID_INT_THROWAWAY_TABLE);
            }
            smash::app::FighterSpecializer_Reflet::change_grimoire(fighter_module_accessor, *FIGHTER_REFLET_MAGIC_KIND_GIGA_FIRE);
        }
        else {
            smash::app::FighterSpecializer_Reflet::change_grimoire(fighter_module_accessor, -1);
        }
